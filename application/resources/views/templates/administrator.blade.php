        ...
        <nav class="navbar navbar-default">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="http://localhost/real_estate_laravel">Real Estate</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="http://localhost/real_estate_laravel/logout">Logout</a></li>				
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
        </nav>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        <a href="{{ url('/add_property')}}" class="list-group-item">Add Property</a>
                        <a href="{{ url('/add_tenancy')}}" class="list-group-item">Add Tenancy</a>
                        <a href="{{ url('/add_tenant')}}" class="list-group-item">Add Tenant</a>
                    </div>
                </div>
                <div class="col-md-9">
                    @yield('content') 
